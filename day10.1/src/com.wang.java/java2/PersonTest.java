...
//		this.eat();
    ...
    public Person(String name){
        this(); //这段代码调用的是上面的空参构造器 public Person(){ }
        this.name = name;
    ...
    public Person(String name,int age){
        this(age);  //这段代码调用的是上面的age构造器 public Person(int age){ }
        this.name = name;
        //this.age = age;
    }
    ...
    public void setAge(int age){ //this可以理解为当前对象
        this.age = age;
    }
